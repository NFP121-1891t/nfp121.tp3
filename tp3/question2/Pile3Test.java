...
public class Pile3Test extends junit.framework.TestCase {
    ...
    public void testAll()
    {
        question2.Pile3 pile1 = new question2.Pile3();
        question2.Pile3 pile2 = new question2.Pile3();
        assertEquals(1, pile1.capacite());
        assertEquals(1, pile2.capacite());
        assertEquals(1, pile1.estPleine());
        assertEquals(1, pile1.estVide());
        assertEquals(1, pile1.toString());
        pile1.empiler(1);
        pile2.empiler(1);
        assertEquals(1, pile2.equals(pile1));
